...
from synthetic_models.ucm_synthetic_model import generate_universal_choice_model
from optimization.ucm_optim import run_ucm_optimization
from copy import deepcopy
import time


def run_ucm_experiments_v2(model_dir, algorithm_list, meta_default, price_range_list, prod_count_list, repeat_count,
